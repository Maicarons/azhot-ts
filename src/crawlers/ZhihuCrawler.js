...
export class ZhihuCrawler extends BaseCrawler {
    constructor() {
        super('zhihu', '知乎', 'https://static.zhihu.com/static/favicon.ico', // 根据Go代码中的图标URL更新
    ...
    async crawl() {
        try {
            ...
            // 检查数据是否为空
            if (!data.recommend_queries || !data.recommend_queries.queries || data.recommend_queries.queries.length === 0) {
