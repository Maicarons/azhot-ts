...
export class GitHubCrawler extends BaseCrawler {
  constructor() {
    super(
      "github",
      "GitHub",
      "https://github.githubassets.com/favicons/favicon.png", // 根据Go代码中的图标URL
  ...
  async crawl() {
    try {
      ...
      const pattern =
        /<span\s+data-view-component="true"\s+class="text-normal">\s*([^<]+)\s*<\/span>\s*([^<]+)<\/a>\s*<\/h2>\s*<p\sclass="col-9 color-fg-muted my-1 pr-4">\s*([^<]+)\s*<\/p>/g;
