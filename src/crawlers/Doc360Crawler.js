...
export class Doc360Crawler extends BaseCrawler {
    constructor() {
        super('360doc', '360doc', 'https://www.360doc.cn/favicon.ico', // 根据Go代码中的图标URL更新
        'http://www.360doc.com/');
    }
    async crawl() {
        try {
            ...
            // 匹配模式：提取链接和标题
            const pattern = /<div class=" num\d* yzphlist hei"><a href="(.*?)".*?>(?:<span class="icon_yuan2"><\/span>)?(.*?)<\/a><\/div>/g;
